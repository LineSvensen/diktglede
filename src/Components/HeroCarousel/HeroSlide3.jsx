...
export default function HeroSlide3() {
  return (
    <div className="bg-rose/10 lg:gap-16 flex flex-col sm:flex-row justify-center items-center text-center h-full w-full px-6 ">
      <div className="flex flex-col text-center items-center ">
        ...
        ></img>
        <h2 className="text-3xl md:text-5xl  text-gray-800 mb-4  pb-2  font-poppins font-extrabold">
          Ny bok 2026
        </h2>

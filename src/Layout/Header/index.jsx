...
export default function Header() {
  ...
  const books = [
    { name: "Vis alle", href: "/diktboker" },
    { name: "Dans på roser", href: "#" },
    { name: "Med roser i hjertet", href: "#" },
    { name: "Roser langs veien", href: "#" },
    { name: "Når en rose visner", href: "#" },
    { name: "God nok", href: "#" },
    { name: "Pakke med alle bøkene", href: "#" },
  ];
